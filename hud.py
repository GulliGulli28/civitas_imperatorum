...
class Hud:
    ...
    def build_hud(self):
        ...
        for name, image in icons.items():
            name = name
            if name == "housing":
                pos = [self.width - right_hud_width + 13.5, 295]
            elif name == "clear":
                pos = [self.width - right_hud_width + 63, 295]
            elif name == "road":
                pos = [self.width - right_hud_width + 113, 295]
            elif name == "water":
                pos = [self.width - right_hud_width + 13.5, 330]
            elif name == "government":
                pos = [self.width - right_hud_width + 63.5, 330]
            elif name == "security":
                pos = [self.width - right_hud_width + 113.5, 330]
            img_tmp = image.copy()
